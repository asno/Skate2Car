...
public class Score
{
    ...
    private readonly Dictionary<Tuple<int, int>, string> SCORE_TO_MSG_MAPPING = new Dictionary<Tuple<int, int>, string>()
    {
        ...
        { new Tuple<int, int>(15000, 85000), "BIEN JOUÉ, VOUS ÊTES\nSUR LA BONNE VOIE !" },
        { new Tuple<int, int>(85001, MAX_POINTS), "VOUS ÊTES AUSSI À L'AISE SUR UN LONGBOARD QU'AVEC LE NOUVEAU DACIA JOGGER,\nBRAVO!" }
    };
